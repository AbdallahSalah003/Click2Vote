...
const ConfirmationDialog: React.FC<ConfirmationDialogProps> = ({
  ...
  return showDialog ? (
    <div style={{"marginTop": "40px"}} className="z-50 fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full">
      <div className="absolute bg-white p-4 rounded-xl drop-shadow-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64">
        ...
        <div className="flex justify-around my-2">
          <button style={{"marginRight": "40px"}} className="boxless" onClick={onCancel}>
            Cancel
          </button>
